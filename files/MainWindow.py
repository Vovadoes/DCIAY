...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1280, 350)
        MainWindow.setMinimumSize(QtCore.QSize(1280, 350))
        MainWindow.setMaximumSize(QtCore.QSize(1280, 350))
        ...
        self.gridLayout_12.addWidget(self.label_53, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Определение доверительного интервала средней урожайности пшеницы"))
        self.label_11.setText(_translate("MainWindow", "<html><head/><body><p>Определение доверительного интервала средней урожайности пшеницы</p></body></html>"))
        ...
        self.label_39.setText(_translate("MainWindow", "<html><head/><body><p>Введите площадь участка, на котором определяется урожайность пшеницы (n <span style=\" font-family:\'YS Text\',\'Arial\',\'Helvetica\',\'Arial Unicode MS\',\'sans-serif\'; font-size:24px; color:#333333; background-color:#ffffff;\">≥</span> 100):</p></body></html>"))
        ...
        self.label_49.setText(_translate("MainWindow", "<html><head/><body><p>Введите надежность:</p></body></html>"))
        self.label_50.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'palatino linotype\',\'new athena unicode\',\'athena\',\'gentium\',\'code2000\',\'serif\'; font-style:italic; color:#202122; background-color:#ffffff;\">γ</span></p></body></html>"))
