...
class Variables:
    ...
    def load(self):
        ...
        self.alpha = mywindow.is_float(self.main_window.ui.doubleSpinBox_10)
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if DEDUG:
            ...
            self.ui.doubleSpinBox_10.setValue(0.95)  # alpha
...
class Finish(QtWidgets.QDialog):
    def __init__(self, parent: mywindow):
        ...
        self.ui.doubleSpinBox_9.setValue(round(self.parent.calculation.x_cp_v, 2))
        self.ui.doubleSpinBox_10.setValue(round(self.parent.calculation.s, 2))
        self.ui.doubleSpinBox_11.setValue(round(self.parent.calculation.b, 2))

        self.ui.doubleSpinBox_2.setValue(round(self.parent.calculation.result[0], 2))
